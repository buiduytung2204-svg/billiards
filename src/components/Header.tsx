    ...
    <header className="bg-slate-900 border-b border-slate-800 text-white px-4 py-3 sticky top-0 z-30 shadow-md">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center space-x-2.5">
          ...
          {/* Staff & Login control */}
          <div className="flex items-center space-x-2 bg-slate-800/90 text-xs px-3 py-1.5 rounded-xl border border-slate-700/80 text-slate-200">
            <UserCheck className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
            <div className="flex items-center space-x-1.5">
              <span className="font-bold text-slate-100 max-w-[130px] truncate">
                {activeStaff ? activeStaff.fullname : 'Chưa đăng nhập'}
              </span>
              {activeStaff && (
                <span
                ...
                >
                  {activeStaff.role === 'Manager' ? 'Quản lý' : activeStaff.role}
                </span>
              )}
            </div>
            ...
            {activeStaff ? (
              <div className="flex items-center space-x-1 pl-1 border-l border-slate-700">
                <button
                  ...
                  className="text-[11px] font-bold text-amber-400 hover:text-amber-300 bg-slate-900 hover:bg-slate-950 px-2 py-0.5 rounded-lg border border-slate-700 transition"
                ...
                <button
                  onClick={onLogout}
                  className="text-[11px] font-bold text-rose-400 hover:text-rose-300 bg-slate-900 hover:bg-slate-950 px-2 py-0.5 rounded-lg border border-slate-700 transition"
              ...
              <button
                onClick={onOpenLoginModal}
                className="ml-1 text-[11px] font-bold text-emerald-400 hover:text-emerald-300 bg-emerald-950/60 hover:bg-emerald-900 px-2.5 py-1 rounded-lg border border-emerald-500/40 transition"
