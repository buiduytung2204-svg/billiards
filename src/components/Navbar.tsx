...
import { LayoutGrid, Package, Users, CalendarCheck, Receipt, ShieldCheck } from 'lucide-react';

export type ActiveTab = 'pos' | 'inventory' | 'customers' | 'bookings' | 'invoices' | 'admin';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const tabs = [
    ...
    },
    {
      ...
      label: 'Quản trị Admin (Chỉnh Giá)',
      icon: ShieldCheck,
      badge: 'Admin',
